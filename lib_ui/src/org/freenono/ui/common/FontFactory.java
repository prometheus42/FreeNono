...
/**
 * Factory class for vending standard <code>Font</code> objects. Wherever possible, this factory
 * will hand out references to shared <code>Font</code> instances.
 * <p>
 * Create methods return a reference to a shared <code>Font</code> object which is ok because Font
 * is immutable. The given object can then be adjusted by the <code>deriveFont()</code> method.
 *
...
public final class FontFactory {
    ...
    /**
     * Initializes the base font that will be used as basis for all other specific fonts.
     */
    static {
        registerFonts();
        setBaseFont();
    ...
    /**
     * Register all fonts shipped with FreeNono to be used in the frames and dialogs.
     */
    private static void registerFonts() {

        // add new font
        try {
            final Font fontLcd = Font.createFont(Font.TRUETYPE_FONT, FontFactory.class.getResourceAsStream("/resources/fonts/LCDMono.TTF"));

            final Font fontDefault =
                    Font.createFont(Font.TRUETYPE_FONT, FontFactory.class.getResourceAsStream("/resources/fonts/LinuxBiolinum.ttf"));
    ...
    private static void setBaseFont() {
        ...
        for (final String s : ge.getAvailableFontFamilyNames()) {
    ...
    /**
     * Creates a lcd like font for displaying game information like game time or fail count.
     *
    ...
    /**
     * Creates a font for displaying textual information, e.g. in dialog boxes etc.
     *
     * @return text font
     */
