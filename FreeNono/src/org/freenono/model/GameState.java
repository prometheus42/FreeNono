...
public enum GameState {
    /**
     * The game is in an undefined state, e.g. it is created but not yet started.
     */
    NONE,

    /**
     * The game has been started and is currently running. This state is also used after a pause has
     * ended.
     */
    RUNNING,
