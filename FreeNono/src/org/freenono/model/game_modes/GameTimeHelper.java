...
public class GameTimeHelper {
	 ...
	 *
	 * @param eventHelper Game event helper to fire timer events.
	 * @param gtd Direction in which timer should count.
	 * @param loadTime Time to be loaded as start value.
	 */
