...
/**
 * Signals that an attempt to read settings has failed, because it doesn't match the expected
 * format.
 *
...
public class SettingsFormatException extends Exception {
    ...
    /**
     * Constructs a new {@code SettingsFormatException} with {@code null} as its detail message. The
    ...
    /**
     * Constructs a new {@code SettingsFormatException} with the specified detail message. The cause
     ...
     */
    public SettingsFormatException(final String message) {
        super(message);
    }
}
