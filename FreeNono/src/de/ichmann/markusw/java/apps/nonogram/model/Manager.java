...
public class Manager {
	...
	public Manager(String nonogramPath, String dataPath) throws InvalidArgumentException, FileNotFoundException, IOException {
		
		if (nonogramPath == null) {
			throw new InvalidArgumentException("Parameter nonogramPath is null");
		}
		if (dataPath == null) {
			throw new InvalidArgumentException("Parameter dataPath is null");
		}
		
		initNonogramData(new File(nonogramPath));
		initSettingsData(new File(dataPath));
		
	}

	private void initSettingsData(File file) {
	...
	private void initNonogramData(File dir) throws FileNotFoundException {
	...
	private void setNonogramList(List<Nonogram> nonogramList) {
