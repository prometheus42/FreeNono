 ...
 * interested in processing an collection event implements this interface, and
 * the object created with that class is registered with
 * <code>CollectionProvider</code>, using the provider's
 * <code>startLoading</code> method. When the collection is loaded, that
 * object's <code>collectionLoading</code> method is invoked.
 * 
...
public interface CollectionListener extends EventListener {
    ...
    /**
     * A semantic event which indicates that a collection-based action occurred.
     * This high-level event is generated by a <code>CollectionProvider</code>
     * when the collection is loaded. The event is passed to the
     * <code>CollectionListener</code> object that registered to receive such
     * events using the component's <code>startLoading</code> method.
     * <p>
     * The object that implements the <code>CollectionListener</code> interface
     * gets this <code>CollectionEvent</code> when the event occurs.
     * 
     * @author Christian Wichmann
     */
    public class CollectionEvent extends EventObject {
        ...
        public CollectionEvent(final Object source,
                final int coursesLoadedComplete, final int coursesInCollection,
        ...
        /**
         * Returns number of courses that have been completely loaded by time of
         * the event.
         * 
        ...
        /**
         * Returns whether this collection has changed, e.g. courses been added,
         * removed or changed.
         * 
    ...
    /**
     * Invoked when a collection is loaded. Every time a course of the nonogram
     * collection is loaded this method is called on all listener.
     * 
     * @param e
     *            collection event
     */
    ...
    /**
     * Invoked when a collection is changed. This can mean that either a course
     * of this nonogram collection was removed, added or changed. Every time
     * this happens this method is called on all listeners.
     * 
     * @param e
     *            collection event
     */
