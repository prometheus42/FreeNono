...
/**
 * Event used for all program control commands like starting or stopping a game. These events are
 * all fired by the user interface.
 *
...
public final class ProgramControlEvent extends GameEvent {
    ...
    /**
     * Initializes a ProgramControlEvent to inform all listeners of a program change like starting
     * or stopping a game.
     *
     * @param source
     *            Source where event was fired.
     * @param pct
     *            Type of program control event.
     */
    ...
    /**
     * Second constructor for use with the ProgrammControlTypes START_GAME, NONOGRAM_CHOSEN and
     * RESTART_GAME. The passed value currentNonogram is the new started, restarted or chosen
     * nonogram.
     *
     * @param source
     *            Source where event was fired.
     ...
     */
    public ProgramControlEvent(final Object source, final ProgramControlType pct, final Nonogram currentNonogram) {
