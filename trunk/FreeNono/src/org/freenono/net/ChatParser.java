...
public class ChatParser {
    ...
    private final StringBuilder returnMessage = new StringBuilder("*** ");
     ...
     *            connection to NonoWeb
     */
    private void parseMessage(final String message, final NonoWebConnection connection) {
     ...
     *            command tokens
     */
    private void executeIson(final NonoWebConnection connection, final String[] tokens) {
    ...
    private void executeUsers(final NonoWebConnection connection) {
        ...
        for (final String player : connection.getAllPlayerNames()) {
     ...
     *            command tokens
     */
    private void executeNick(final NonoWebConnection connection, final String[] tokens) {
