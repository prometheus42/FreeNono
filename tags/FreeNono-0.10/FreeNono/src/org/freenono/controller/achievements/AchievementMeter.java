...
/**
 * Provides an interface for all achievement meter classes. The classes represent a common
 * description for measuring the accomplishment of an achievement.
 *
...
public abstract class AchievementMeter {
    ...
    /**
     * Instantiates a new measuring object for checking if an achievement has been accomplished.
     *
     * @param achievement
