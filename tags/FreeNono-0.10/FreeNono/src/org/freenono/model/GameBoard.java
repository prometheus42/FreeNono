...
public class GameBoard {
    ...
    /**
     * Default constructor initializing a GameBoard with free fields and storing the pattern of the
     * current nonogram for future references.
     *
     * @param nonogram
    ...
    /**
     * Checks whether a field can be marked. It can not be marked if it is already occupied.
     *
     * @param x
    ...
    /**
     * Checks if the specified field could be target of the next move. It returns false, if the
     * specified field is marked or already occupied.
     *
     * @param x
     *            Specifies the horizontal index of the field.
     * @param y
    ...
    /**
     * Solves the game. This functions sets all field values to the right values so that the
     * nonogram is solved. This function should be called after to clear the field for a nice view.
     */
    public final void solveGame() {

        int y;
        int x;
        final int height = pattern.height();
        final int width = pattern.width();
