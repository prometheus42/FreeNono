...
public class GameMode_MaxFail extends GameMode {
     ...
     */
    public GameMode_MaxFail(final GameEventHelper eventHelper, final Nonogram nonogram, final Settings settings) {
    ...
    /**
     * Subtracts one failed move from fail count and fires a set fail count event.
     */
    protected final void processFailedMove() {

        failCount--;
        getEventHelper().fireSetFailCountEvent(new StateChangeEvent(this, failCount));
    }
