...
/**
 * Static factory class providing <code>CollectionProvider</code> for various sources of nonogram
 * collections.
 *
...
public final class Providers {
     ...
     */
    public static CollectionProvider collectionFromFilesystem(final String rootPath, final String name, final boolean concurrently) {

        return new CollectionFromFilesystem(rootPath, name, concurrently);
    }

    /**
     * Provides a collection from file system by its path. The data is read synchronously.
     *
     * @param rootPath
     *            path to search for nonogram courses
     * @param name
     ...
     * @return a collection provider containing all courses from file system
     */
    public static CollectionProvider collectionFromFilesystem(final String rootPath, final String name) {
     ...
     */
    public static CollectionProvider collectionFromJar(final String jarPath, final String name) {

        return new CollectionFromJar(jarPath, name);
    }

    /**
     * Provides a collection from a single jar file. This collection searches automatically for
     * nonogram collections in a jar file and loads it.
     *
     * @param name
     *            name of the provider
     * @return a collection provider containing all courses from jar file
     ...
     */
    public static CollectionProvider collectionFromServer(final String serverURL, final String name) {
